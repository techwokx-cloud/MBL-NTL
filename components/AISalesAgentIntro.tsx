...
export function AISalesAgentIntro() {
  ...
  return (
    <section className="bg-ntl-navy text-white">
      <div className="max-w-7xl mx-auto px-6 py-14 grid lg:grid-cols-2 gap-10 items-center">
        <Reveal>
          ...
          <button
            onClick={openChat}
            className="flex items-center gap-2 bg-sulnox-green hover:bg-sulnox-green/90 text-white font-semibold px-6 py-3 rounded-lg transition-colors"
          >
        ...
        <Reveal delay={100} className="bg-white rounded-2xl shadow-2xl overflow-hidden text-gray-900">
